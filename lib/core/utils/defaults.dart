...
Future<void> seedDefaultProjects() async {
  ...
  if (projectBox.isEmpty) {
    await projectBox.addAll([
      ProjectModel(name: "Inbox", color: const Color(0xff4F46E5)),
      ProjectModel(name: "Personal", color: const Color(0xff4F46E5)),
      ProjectModel(name: "Work", color: const Color(0xff4F46E5)),
    ]);
  }
}
