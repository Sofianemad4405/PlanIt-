...
Future<void> seedDefaultProjects() async {
  ...
  if (projectBox.isEmpty) {
    await projectBox.addAll([
      ProjectModel(name: "Inbox", color: ColorModel(0xff4F46E5), id: "1"),
      ProjectModel(name: "Personal", color: ColorModel(0xff4F46E5), id: "2"),
      ProjectModel(name: "Work", color: ColorModel(0xff4F46E5), id: "3"),
    ]);
  }
}
